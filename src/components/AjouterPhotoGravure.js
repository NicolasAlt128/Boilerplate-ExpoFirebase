...
export default class AjouterPhotoGravure extends React.Component {
  ...
  async uploadImageAsync(uri) {
    ...
    let pathFile = 'Gravure'+'/'+this.state.idMission+'/'+uuid+'.jpg';

    var storageRef = firebase.storage().ref();
    var gravureRef = storageRef.child(pathFile);

    const snapshot = await gravureRef.put(blob);

    const result = gravureRef.getDownloadURL().then(function(url){
      return url
    });
