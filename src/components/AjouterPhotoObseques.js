...
export default class AjouterPhotoObseques extends React.Component {
  ...
  async uploadImageAsync(uri) {
    ...
    let pathFile = 'Obseques'+'/'+this.state.idMission+'/'+uuid+'.jpg';

    var storageRef = firebase.storage().ref();
    var obsequesRef = storageRef.child(pathFile);

    const snapshot = await obsequesRef.put(blob);

    const result = obsequesRef.getDownloadURL().then(function(url){
      return url
    });
