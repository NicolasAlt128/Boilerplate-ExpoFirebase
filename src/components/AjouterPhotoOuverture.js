...
export default class AjouterPhotoOuverture extends React.Component {
  ...
  async uploadImageAsync(uri) {
    ...
    let pathFile = 'Ouverture'+'/'+this.state.idMission+'/'+uuid+'.jpg';

    var storageRef = firebase.storage().ref();
    var ouvertureRef = storageRef.child(pathFile);

    const snapshot = await ouvertureRef.put(blob);

    const result = ouvertureRef.getDownloadURL().then(function(url){
      return url
    });
