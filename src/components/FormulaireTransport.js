...
class FormulaireTransport extends Component {
  ...
  goToNextStep = () => {
    ...
    let idMission = 'T_'+dateBDD+'-'+this.state.nom;
    this.props.navigation
    .navigate('PhotoTransport',
    {
      idMission:idMission,
      nom:this.state.nom,
      date:this.state.date,
      lieuDepart:this.state.lieuDepart,
          ...
          { this.state.show && (
            ...
            <View style={{justifyContent:'center', paddingLeft:15, paddingRight:15 }}>
              ...
              <View style={formulaireMissionStyles.form}>
                ...
                <Text>Depart de : </Text><TextInput onChangeText={lieuDepart => this.setState({lieuDepart: lieuDepart})} />
              </View>

              <View style={formulaireMissionStyles.form}>
                <Icon type='material' name='place' size={22} style={formulaireMissionStyles.iconForm} />
                <Text>Arrivé à : </Text><TextInput onChangeText={lieuArrive => this.setState({lieuArrive: lieuArrive})} />
              </View>
